            ...
            <SwiperSlide>
              <div className="slideBox">
                <div className="txtBox">
                  ...
                  <h2>판소리로 듣는 궁 이야기</h2>
                  <p>
                    세워지고 무너지고, 세워지고 무너지기를 반복하는 궁의 끈질긴
                    생명력과 그것을 기억하는 이들에 대한 이야기.2023년
              ...
              <div className="slideBox">
                <div className="txtBox">
                  ...
                  <p>
                    ...
                    공연입니다.아름다운 가을밤, 고즈넉한 궁궐에서 국악과 발레의
                    크로스오버 공연을 즐겨보세요.
                  </p>
                </div>
              ...
              <div className="slideBox">
                <div className="txtBox">
                  ...
                  <p>
                    ...
                    개폐의식, 궁성 수위의식, 순라의식 등의 기록 자료를 바탕으로
                    1996년부터 재현하고 있는 행사입니다.
                  </p>
                </div>
            ...
            <SwiperSlide>
              <div className="slideBox">
                <div className="txtBox">
                  ...
                  <h2>대한제국 외국공사접견례</h2>
                  <p>
                    대한제국 외국공사접견례는 대한제국 시기 외교 상황을 연극으로
                    재구성하여 역사의 한 장면을 직접 볼 수 있도록 재현하는
                    행사입니다. 1900년을 배경으로 외국공사들이 고종을 알현하는
                    의례와 연회를 재현하여, 당시 공사 접견 방법과 더불어 군악대
                    연주, 검무, 사자춤 등의 당시 연회 무대가 펼쳐집니다.
                  </p>
                </div>
