...
const GallerySection = () => {
  ...
  const nextSlide = () => {
    setCurrentSlide((prevSlide) =>
      prevSlide === totalSlidesToShow ? 0 : prevSlide + 1,
    );
  ...
  const prevSlide = () => {
    setCurrentSlide((prevSlide) =>
      prevSlide === 0 ? totalSlidesToShow : prevSlide - 1,
    );
    setBackCurrentSlide(
      (prevSlide2) => (prevSlide2 - 1 + images2.length) % images2.length,
    );
  };
  // useEffect(() => {
    ...
    <section className="GallerySection">
      <div className="slider-container">
        ...
        <div className="slider-container2">
          <div className="GallerySlideBox1">
            <div
              className="slider-track1"
              style={{ transform: `translateX(-${backCurrentSlide2 * 100}%)` }}
            >
              {images.map((image2, index) => (
                <div className="slider-slide1" key={index}>
                  <img
        ...
        <div className="GallerySlideBox2">
          <div
            ...
            style={{
              transform: `translateX(-${currentSlide * (400 / slidesToShow)}%)`,
            }}
          >
